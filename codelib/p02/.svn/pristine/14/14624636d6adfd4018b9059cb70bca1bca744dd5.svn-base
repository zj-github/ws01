...
public class SQLUtil2 {
	...
	public synchronized static void handccfa(String type,CCFAProjectInfo ccfap,StringBuilder columnsbtmp,StringBuilder statmsbtmp,List<String> l) {
		//1、column 
		//2、?????
		//3、values
...
//		String[] columns = columnMapping.get(type).split(",");
