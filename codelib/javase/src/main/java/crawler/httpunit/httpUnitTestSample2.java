...
public class httpUnitTestSample2 {
...
//		System.out.println(result.getUrl().toString());
	 ...
	 * @throws SAXException
	 */
	public static void testGetHtmlContent(String url) throws MalformedURLException, IOException, SAXException {
	 ...
	 * @throws SAXException
	 */
	public static void testClickLink() throws MalformedURLException, IOException, SAXException {
	 ...
	 * @throws SAXException
	 */
	public static void testTableContent() throws MalformedURLException, IOException, SAXException {
		...
		while (i < n) {
			j = 0;
			while (j < m) {
				System.out.println("表格中第" + (i + 1) + "行第" + (j + 1) + "列的内容是：" + datas[i][j]);
				++j;
			}
			++i;
		}
	 ...
	 * @throws SAXException
	 */
	public static void testHtmlContentForm() throws MalformedURLException, IOException, SAXException {
		...
		while (i < m) {
			System.out.println(
					"第" + (i + 1) + "个控件的名字是" + pNames[i] + "，里面的内容是" + (webForm.getParameterValues(pNames[i])));
			++i;
		}
	}
